...
model = AutoModelForCausalLM.from_pretrained("vilsonrodrigues/falcon-7b-instruct-sharded", torch_dtype=torch.float16)
...
with gr.Blocks() as demo:
    ...
    gr.Markdown(
        """
        # Converse with the locally run LLM agent
        """)
